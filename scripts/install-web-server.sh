...
WEBSERVERBASHFILE="bash <( curl https://raw.githubusercontent.com/thecrypt0hunter/redstone-trustaking/master/scripts/install-web-server.sh )"
COINSERVICEBASHFILE="bash <( curl https://raw.githubusercontent.com/thecrypt0hunter/redstone-trustaking/master/scripts/install-redstone-node.sh )"
HOTWALLETSETUPBASHFILE= "bash <( curl https://raw.githubusercontent.com/thecrypt0hunter/redstone-trustaking/master/scripts/hot-wallet-setup.sh )"
