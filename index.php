			...
			<!-- Header -->
				...
				<!-- Banner -->
					<section id="banner">
						...
						<p>We are currently running testnet! <br />We have opened a crowdfunding page <a href="https://btcpay.trustaking.com/apps/3ZLoV6ywKzV1JTBdx6DXEBWHXSxe/crowdfund">here</a> if you want to help.</p>
